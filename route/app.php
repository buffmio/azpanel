...
Route::put('/user/server/azure/firewall/:uuid/:name',    'UserAzureServer/updateFirewallRule')->pattern(['name' => '[^/]+']);
Route::delete('/user/server/azure/firewall/:uuid/:name', 'UserAzureServer/deleteFirewallRule')->pattern(['name' => '[^/]+']);
